...
% added electron wavelength, by Zhen Chen
if isfield(p,'electron') && p.electron % electron,  keV 
    p.lambda = 12.3986./sqrt((2*511.0+p.energy).*p.energy)*1e-10; % m
else % photon, energy, keV
