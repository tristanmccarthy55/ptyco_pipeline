...
component remains spectroscopically accessible, the O~K edge being $78\%$ dichroic to the
polar-axis orientation with a monotonic $19\%$ arising from the displacement itself. Recovering
...
\begin{figure*}[t]
  ...
  \caption{Local polarisation from the located atoms. (a) In-plane Ti--O$_6$ off-centring
    ...
    component. In-plane the uncertainty is a small fraction of the signal, whereas along the
...
\begin{figure*}[t]
  ...
  \caption{Orientation dichroism of the PbTiO$_3$ O~K edge from core-hole CASTEP and OptaDOS.
...
For the tetragonal cell with its polar axis along the beam, the O~K edge is strongly dichroic,
with $\max|\Delta|/\max S = 78\%$ and $\int|\Delta|/\int S=47\%$ (Fig.~\ref{fig:eels}). The
...
spectroscopically accessible in principle, the O~K edge being $78\%$ dichroic to the polar-axis
orientation, of which a monotonic $19\%$ is the signature of the displacement rather than of the
...
noise floor of the volume is $\sigma\approx0.023$ and the oxygen peak amplitude
...
four in five species labels are wrong, yet precision still reads $0.95$, because the surviving
...
\begin{table}[t]
  ...
  \begin{tabular}{@{}lccccc@{}}
    \toprule
    injected $\sigma$ & found & precision & Pb & Ti & O \\
    \midrule
    0                 & 1878 & 0.95 & 88\,\% & 89\,\% & 90\,\% \\
    0.01              & 1825 & 0.96 & 88\,\% & 90\,\% & 87\,\% \\
    0.02              & 1462 & 0.98 & 87\,\% & 89\,\% & 60\,\% \\
    0.04              & \phantom{0}786 & 0.96 & 87\,\% & 82\,\% & \phantom{0}5\,\% \\
    0.08              & \phantom{0}407 & 0.95 & 87\,\% & \phantom{0}0\,\% & \phantom{0}0\,\% \\
    \bottomrule
  \end{tabular}
  \caption{Injected-noise sweep on the coherent volume, all other settings fixed. Species
    confusion rises from $1.1\%$ at $\sigma=0$ to $3.9\%$ at $0.02$, $65\%$ at $0.04$ and $76\%$
    at $0.08$. Run, as with Table~\ref{tab:dose}, in the configuration preceding the
    guided-detection deduplication guard.}
  \label{tab:noise}
\end{table}
